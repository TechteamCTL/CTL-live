...
const ProductListPage = () => {
    ...
    return <ProductListPageComponent3 getUser={getUser} getProducts={getProducts} categories={categories} subCat={subCategoryName} childCat={childCategoryName} fourCat={fourCategoryName} />;
